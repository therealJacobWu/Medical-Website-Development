...
<%
    ...
    if (request.getParameter("reminder_msg") != null) {
        String msgParameter = request.getParameter("reminder_msg");
        int msgIndex = 0;
        try {
        ...
        if (session.getAttribute("reminderMessages") != null) {
            messages = (List<MessageBean>) session.getAttribute("reminderMessages");
...
<table>
    ...
    <tr>
        <td colspan="2"><a href="viewReminderMessages.jsp">Back</a></td>
    </tr>
</table>
