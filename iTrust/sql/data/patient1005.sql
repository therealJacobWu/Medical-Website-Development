...
INSERT INTO users(MID, password, role, sQuestion, sAnswer) 
			VALUES (1005, '30c952fab122c3f9759f02a6d95c3758b246b4fee239957b2d4fee46e26170c4', 'patient', 'opposite of yin', 'yang')
 ON DUPLICATE KEY UPDATE MID = MID;
 /*password: pw*/
...
INSERT INTO declaredhcp(PatientID,HCPID) VALUE(1005, 9000000003)
 ON DUPLICATE KEY UPDATE PatientID = PatientID;

INSERT INTO representatives(RepresenterMID, RepresenteeMID) VALUES(2,1005)
