...
public class LoginTest extends iTrustSeleniumTest {
	...
	public void testResetPassword() throws Exception {
		...
		assertEquals("iTrust - Reset Password", driver.getTitle());
		driver.findElementByName("mid").sendKeys("1");
		driver.findElements(By.cssSelector("input[type=\"submit\"]")).get(1).click();

        driver.findElement(By.cssSelector("input[name=\"answer\"]")).sendKeys("blue");
        driver.findElement(By.cssSelector("input[name=\"password\"]")).sendKeys("newPw12345");
        driver.findElement(By.cssSelector("input[name=\"confirmPassword\"]")).sendKeys("newPw12345");
        driver.findElements(By.cssSelector("input[type=\"submit\"]")).get(1).click();
	}
}