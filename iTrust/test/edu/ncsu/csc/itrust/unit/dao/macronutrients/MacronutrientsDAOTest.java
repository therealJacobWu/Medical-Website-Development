...
public class MacronutrientsDAOTest extends TestCase {
	...
	private ViewMacronutrientsAction macronutrientsDAO;
	...
	@Test
	public void testGetMsj() throws ITrustException {
		macronutrientsDAO = new ViewMacronutrientsAction(factory, 341L);
		try {
			MacronutrientsBean macronutrients = macronutrientsDAO.getMsjData(341);
			assertTrue(1326.25 == macronutrients.getMsj());
			assertEquals(42, macronutrients.getYears());
		} catch (DBException e) {
